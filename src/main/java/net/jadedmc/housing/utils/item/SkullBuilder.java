package net.jadedmc.housing.utils.item;
...
public class SkullBuilder {
    ...
    public SkullBuilder addLore(String[] arr, String starter) {
        ...
        for(String str : arr) {
            lore.add(ChatUtils.legacyTranslate(starter + str));
        }
    ...
    public SkullBuilder addLore(String str) {
        ...
        lore.add(ChatUtils.legacyTranslate(str));
        meta.setLore(lore);
    ...
    public SkullBuilder setDisplayName(String str) {
        meta.setDisplayName(ChatUtils.legacyTranslate(str));
        return this;
    }
